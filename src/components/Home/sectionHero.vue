...
<template>
    <div class="flex items-center flex-col  bg-indigo-600/75">
        ...
        <div class="flex flex-col mx-auto items-center">
            <h1 class=" mx-auto text-6xl text-center font-bold my-6 md:w-2/3" v-text="title"/>
           
            <p class=" mx-auto text-2xl text-center md:w-1/2 " v-text="description"/>
        </div>
        ...
        <div class=" mt-10 space-y-12">
            ...
            <div class="flex mx-auto flex-row space-x-10 " v-for="logos in logo">
                <img :src="logos"/>
            </div>
        </div>
    </div>
